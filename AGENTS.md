...
## Field Copilot priority

HVAC / Field Copilot is priority 1.

Use local files, scripts, schemas, and docs before deploying paid cloud services. Keep the AWS direction, but avoid cloud spend until the local demo and data layer are stable.
